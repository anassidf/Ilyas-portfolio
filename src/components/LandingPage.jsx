...
const LandingPage = () => {
  return (
    <section id='landing-section' className='bg-landing-page-image w-full h-[80vh] lg:h-[90vh] bg-cover bg-center'>
        <div className='w-full h-full bg-black opacity-70 relative'>
        <div className='flex justify-center'>
          <p className='text-white text-center text-3xl lg:text-4xl pt-40 w-[75%] break-words leading-9 lg:leading-10 '>Welcome to ME Business Development
